...
const project = (
  await sharp("public/work/perranvale/desktop-1080.webp").resize(554).png().toBuffer()
).toString("base64");
...
<image href="data:image/png;base64,${project}" x="590" y="155" width="554" height="346" clip-path="url(#project)"/>
